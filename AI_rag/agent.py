...
async def create_rag_agent():
    ...
    system_prompt = (
        "You have access to the retrieve_context tool. "
        "Always begin by calling this tool to find relevant information before answering. "
        "Never answer without first searching the document database."
    )
